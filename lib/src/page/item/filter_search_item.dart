                    ...
                    return Column(
                      children: [
                        DropdownButtonFormField(
                          ...
                          items: state.list.map<DropdownMenuItem<Category>>(
                              (Category value) {
                              ...
                              validator: (value) {
                                if (value != null && value.isNotEmpty) {
                                  try {
                                    ...
                                    if (search.min != null &&
                                        check < search.min!) {
                                      return 'Phải lớn hởn hoặc bằng giá tối thiểu';
                                    }
                                  } catch (e) {
                                    return 'Nhập lại';
                                  }
                          ...
                          DataCell(
                            ...
                            onTap: () {
                              ...
                              context.pop(ItemSearch(
                                  search: search.search,
                                  sortBy:
                                      AppConstants.listSortModel.first.query,
                                  storeID: search.storeID,
                                  page: 1,
                                  itemStatusID: search.itemStatusID));
                            },
                            ...
                            onTap: () {
                              if (_formKey.currentState!.validate()) {
                                context.pop(search.copyWith(
                                    max: double.tryParse(
                                        _max.text.trim().replaceAll('.', '')),
                                    min: double.tryParse(
                                        _min.text.trim().replaceAll('.', ''))));
                              }
                            },
                          ),
                        ]),
