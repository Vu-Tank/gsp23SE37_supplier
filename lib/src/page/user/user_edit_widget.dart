...
//     {required BuildContext context, required String type, required User user}) {
//   Adderss address = user.addresses[0];
...
//                   : null);
//   final formKey = GlobalKey<FormState>();
//   String otherValue = (type == 'gender') ? user.gender : '';
...
//                                               if (districtState
//                                                   is DistrictLoaded) {
//                                                 address.district = districtState
//                                                     .district.value;
//                                                 if (districtState
//                                                         .district.key !=
//                                                     '-1') {
...
//                                   }
//                                   if (type == 'email') {
//                                     return Validations.valSupplierEmail(value);
//                                   }
//                                   return null;
//                                 },
//                                 maxLength: 100,
