...
class _DashboardPageState extends State<DashboardPage> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      create: (context) =>
          LoadHomeCubit()..load(userId: user.userID, token: user.token),
      child: BlocBuilder<LoadHomeCubit, LoadHomeState>(
          ...
          if (state is LoadHomeSuccess) {
                                  ...
                                  child: BlocProvider(
                                    create: (context) => ItemHotCubit()
                                      ..loadHotItem(
                                          ...
                                          storeID: store.storeID),
                                    child:
                                        BlocBuilder<ItemHotCubit, ItemHotState>(
                                      builder: (context, state) {
            ...
            return blocLoadFailed(
              ...
              reload: () {
                context
                    .read<LoadHomeCubit>()
                    .load(userId: user.userID, token: user.token);
              },
            );
          } else {
            return const Center(
