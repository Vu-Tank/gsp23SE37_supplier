...
import 'package:gsp23se37_supplier/src/model/item/sub_item_request_data.dart';
import 'package:image_picker/image_picker.dart';

import '../../model/api_response.dart';
import '../../model/item/specification_custom_request.dart';
      ...
      if (check) {
        ...
        ApiResponse apiResponse = await ItemRepositories.addItem(
            ...
            listSpecitication: List<String>.from(
                ...
                .toString(),
            listModel: event.listModel.toString(),
            listSpecificationCustom: List<String>.from(event
                .listSpecificationCustom
                .map((e) => e.toJson().toString())).toString());
